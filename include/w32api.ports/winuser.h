...
__dllimport HMENU __stdcall GetMenu(HWND hWnd);
__dllimport int __stdcall SetMenu(HWND hWnd, HMENU hMenu);
__dllimport int __stdcall EndDialog(HWND hDlg, INT_PTR nResult);
